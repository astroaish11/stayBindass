...
<div class="breadcrumb">
    ...
    <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a>Preferences</a>
</div>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-6 mb-4 forminput">
                                ...
                                <select name="state" id="row_per_page" class="form-control">
                            ...
                            <div class="col-6 mb-4  forminput">
                                <label for="lang">Data Seperator </label><br>
                                <select name="state" id="data_seperator" placeholder="Enter City" class="form-control">
                                    <option value="0">-</option>
                                    <option value="1">/</option>
                                    <option value="2">.</option>
                                    <div id="data_seperator_err" class="errordiv text-danger"></div>
                                </select>
                            </div>

                            <div class="col-6 mb-4  forminput">
                                <label for="lang">Date Format </label><br>
                                <select name="state" id="date_format" placeholder="Enter City" class="form-control">
                                    ...
                                    <div id="date_format_err" class="errordiv text-danger"></div>
                                </select>
                            </div>

                            <div class="col-6 mb-4  forminput">
                                <label for="lang">Timezone </label><br>
                                <select name="state" id="timezone" placeholder="Enter City" class="form-control">
                                ...
                                UTC/GMT -07:00 - America/Ciudad_Juarez
                              </option>
                                ...
                                UTC/GMT +00:00 - UTC
                                    ...
                                    <div id="timezone_err" class="errordiv text-danger"></div>
                                </select>
                            </div>

                            <div class="col-6 mb-4  forminput">
                                <label for="lang">Money Symbol Position</label><br>
                                <select name="state" id="money_position" placeholder="Enter City" class="form-control">
                                    <option value="">Before { $500 }</option>
                                    <option value="">After { 500$ }</option>
                                    <div id="money_position_err" class="errordiv text-danger"></div>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-12 text-right">
                            ...
                            <a href="preferences.php" name="cancel" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
