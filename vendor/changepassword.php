                            ...
                            <div class="col-md-12">
                                <div class="box box-primary">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="password" required placeholder="Enter ..." class="form-control form-control-user" name="opass" value="<?php echo $opass; ?>" id="title">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                        <label> New Password<span class="red">*</span></label>
                                        <input type="password" required placeholder="Enter ..." class="form-control form-control-user" name="npass" value="<?php echo $npass; ?>" id="title">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                        <label> Confirm Password<span class="red">*</span></label>
                                        <input type="password" required placeholder="Enter ..." class="form-control form-control-user" name="cpass" value="<?php echo $cpass; ?>" id="title">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <p style="margin-left: 17px; color: red; float: left;"><?php echo $errorMsg; ?></p>
                                        <?php if(isset($_GET['u'])) { ?>
                                            <p style="margin-left: 17px; float: left;">Password Updated Successfully !!!</p>
                                        <?php } ?>
