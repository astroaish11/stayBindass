...
mysqli_query($sql, "UPDATE `awt_meal` SET `adult1`='$adult1_price',`adult2`='$adult2_price',`adult3`='$adult3_price',`adult4`='$adult4_price',`child1`='$child1_price',`child2`='$child2_price',`child3`='$child3_price',`child4`='$child4_price',`short_desc`='$desc',`upload_image`='$image',`v_id`='$vid',`updated_date`='$cdate',`updated_by`='1' WHERE `id` = '$vid'");
...
$query = mysqli_query($sql, "SELECT * FROM `awt_meal` WHERE deleted != '1' and v_id = '$vid'");
