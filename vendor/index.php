...
<div class="row justify-content-center mt-5">
                ...
                <div class="row">
                    ...
                    <div class="p-4">
                        <div class="text-center">
                         ...
                         <h1 class="h4 text-gray-900 mb-4 mt-3 text-da"> Welcome Vendors!</h1>
                            ...
                            <div class="form-group">
                                ...
                                id="username" name="username" value="<?php echo $username; ?>" aria-describedby="emailHelp"  placeholder="Enter Username">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                <!-- <a href="vendor_forget_password.php">Forget Password</a> -->
    ...
    <script type="text/javascript" src="<?php echo MAINLINK;?>js/validate/login.js"> </script>
