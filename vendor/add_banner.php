...
<div class="breadcrumb">
  ...
  <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a>Add Banner</a>
</div>
          ...
          <form>
            <div class="row">
              <div class="col-6 mb-4">
                <label for="tel">Heading<span class="text-danger "> *</span></label>
                <input type="text" class="form-control form-control-user" id="tel" placeholder="">
                <div id="tel_error" class="errordiv text-danger"></div>
              </div>

              <div class="col-6 mb-4">
                <label for="sid">Subheading<span class="text-danger "> *</span></label>
                <input type="text" class="form-control form-control-user" id="sid" placeholder="">
                <div id="sid_error" class="errordiv text-danger"></div>
              </div>

              <div class="col-6 mb-4">
                <label for="symbol">Image<span class="text-danger "> *</span></label>
                <input type="file" class="form-control form-control-user" id="symbol" placeholder="">
              ...
              <div class="col-12 text-left">
                ...
                <a href="add_banner.php" name="cancel" class="btn btn-danger">Cancel</a>
              </div>
