                          ...
                          <tr>
                            ...
                            <th>Extra Guest Price</th>
                                ...
                                while ($list_data = mysqli_fetch_object($getdate_query)) {
                                    ...
                                    echo ' <tr>
                            <td><input type="text" class="form-control" value="' . $list_data->select_date . '" id="date' . $x . '" name="date' . $x . '"></td>

                            <td><input type="text" class="form-control" value="' . $list_data->property_price . '" id="prop_price' . $x . '" name="prop_price' . $x . '"></td>

                            <td><input type="text" class="form-control" value="' . $list_data->guest_price . '" id="g_price' . $x . '" name="g_price' . $x . '"></td>
