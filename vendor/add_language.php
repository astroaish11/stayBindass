...
<div class="breadcrumb">
  ...
  <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a>Add Language</a>
</div>
        ...
        <div class="card-body">
          <form>
            <div class="row">
              ...
              <div class="col-6 mb-4">
                <label for="sid">Short Name<span class="text-danger "> *</span></label>
              ...
              <div class="col-6 mb-4  forminput">
                <label for="default">Enable RTL<span class="text-danger">*</span> </label><br>
              ...
              <div class="col-12 text-left">
                ...
                <a href="add_language.php" name="cancel" class="btn btn-danger">Cancel</a>
              </div>
