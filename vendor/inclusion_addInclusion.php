...
<div class="breadcrumb">
    ...
    <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a>Add Inclusion</a>
</div>
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 text-right">
                            ...
                            <a href="inclusion_addInclusion.php" name="cancel" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
