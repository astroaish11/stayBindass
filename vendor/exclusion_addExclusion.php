...
<div class="breadcrumb">
    ...
    <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a>Add Exclusion</a>
</div>
                ...
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 text-right">
                            ...
                            <a href="exclusion_addExclusion.php" name="cancel" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
