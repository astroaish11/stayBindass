...
<div class="breadcrumb">
    ...
    <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a> Testimonial Management </a>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-header">
                    <a class="btn btn-primary btn-sm float-right" href="add_testimonial.php" role="button">Add Testimonial</a>
                </div>
                <div class="box">
                    <div class="box-body">
                        <table class="table table-bordered myTable " id="myTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <TD>John De</TD>
                                    <td>Traveller</td>
                                    <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, at.</td>
                                    <td>⭐⭐⭐⭐⭐</td>
                                    <td>Active</td>
                                    <td>27-12-2022 9:20am</td>
