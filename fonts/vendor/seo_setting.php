...
<div class="breadcrumb">
    ...
    <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a>Metas Management</a>
                        ...
                        <table class="table table-bordered myTable " id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th width="15%" class="text-center">Keyword</th>
