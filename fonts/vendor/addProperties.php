                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-4 mb-4  forminput">
                                ...
                                <select name="vendor" id="vendor" class="form-control">
                                    ...
                                    <?php vendor($sql, $vendor); ?>
                                    <div id="vendor_err" class="errordiv text-danger"></div>
                                </select>
                            </div>
                            <div class="col-4 mb-4 forminput">
                                <label for="title">Property Name<span class="text-danger">*</span></label>
                                <input type="text" id="title" class="form-control" name="title"
                                    value="<?php echo $title; ?>" placeholder="Enter Property Name" required />
                        ...
                        <div class="row">
                            <div class="col-2 mb-4  forminput">
                                ...
                                <select name="bhk[]" id="bhk" class="form-control" multiple multiselect-search="true"
                                    multiselect-select-all="true" required multiselect-max-items="30">
                            ...
                            <div class="col-2 mb-4  forminput">
                                <label for="guest">Guest<span class="text-danger">*</span> </label><br>
                                <select name="guest" id="guest" class="form-control">
                                    <option value="">Select Guest</option>
                                    <?php guest($sql, $guestname); ?>
                                    <div id="guest_err" class="errordiv text-danger"></div>
                                </select>
                            </div>
                            <div class="col-2 mb-4  forminput">
                                <label for="nights">Nights<span class="text-danger">*</span> </label><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 mb-4 forminput">
                                <label for="title">Villa Qunatity <span class="text-danger">*</span></label>
                                <input type="text" id="villaQuantity" class="form-control" name="villaQuantity"
                                    value="<?php echo $villaQuantity; ?>" placeholder="Enter Villa Quantity" required />
                        ...
                        <div class="row">
                            <div class="col-12 mb-4  forminput">
                                ...
                                <textarea name="specification" id="specification" class="form-control" row="4"
                                    ><?php echo $specification; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-12 mb-4  forminput">
                                <label for="location_link">Location Link<span class="text-danger">*</span></label>
                        ...
                        <div class="col-12 text-right">
                            ...
                            <!-- <a href="manage_listing_property_setting.php" name="continue" class="btn btn-primary">Continue</a> -->

                            <button type="submit" name="submit" id="submit" class="btn btn-primary ml-2">Submit</button>
                            <a href="addProperties.php" name="reset" class="btn btn-danger ml-2">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
