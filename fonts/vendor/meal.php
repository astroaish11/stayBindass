...
<div class="container-fluid ">
    ...
    <div class="row">
        ...
        <div class="card mb-4">
            ...
            <button class="tablink"><a href="video.php?vid=<?php echo $vid; ?>">Video</a></button>
...
<div class="container-fluid">
    ...
    <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">                      
                         <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="adult1">Adult<span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" value="<?php echo $adult1;?>" id="adult1_price"
                                        placeholder="Enter Price" name="adult1_price" required>
                                    <div id="adult1_err" class="errordiv text-danger"></div>
                                </div>

                                <div class="col-6">
                                    <label for="child1">Child<span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control" value="<?php echo $child1;?>" id="child1_price"
                                        placeholder="Enter Price" name="child1_price" required>
                                ...
                                <div class="col-6">
                                    <label for="adult2">Adult<span class="text-danger"> *</span></label>
                    
                                    <input type="text" class="form-control" value="<?php echo $adult2;?>" id="adult2_price"
                                        placeholder="Enter Price" name="adult2_price" required>
                                    <div id="adult2_err" class="errordiv text-danger"></div>
                                </div>

                                <div class="col-6">
                                    <label for="child2">Child<span class="text-danger"> *</span></label>
                                    
                                    <input type="text" class="form-control" value="<?php echo $child2;?>" id="child2_price"
                                        placeholder="Enter Price" name="child2_price" required>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">                       
                      <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="adult3">Adult<span class="text-danger"> *</span></label>
                                   
                                    <input type="text" class="form-control" value="<?php echo $adult3;?>" id="adult3_price"
                                        placeholder="Enter Price" name="adult3_price" required>
                                    <div id="adult3_err" class="errordiv text-danger"></div>
                                </div>

                                <div class="col-6">
                                    <label for="child3">Child<span class="text-danger"> *</span></label>
                                    
                                    <input type="text" class="form-control" value="<?php echo $child3;?>" id="child3_price"
                                        placeholder="Enter Price" name="child3_price" required>
                                ...
                                <div class="col-6">
                                    <label for="adult4">Adult<span class="text-danger"> *</span></label>
                                    
                                    <input type="text" class="form-control" value="<?php echo $adult4;?>" id="adult4_price"
                                        placeholder="Enter Price" name="adult4_price" required>
                                    <div id="adult4_err" class="errordiv text-danger"></div>
                                </div>

                                <div class="col-6">
                                    <label for="child4">Child<span class="text-danger"> *</span></label>
                                    
                                    <input type="text" class="form-control" value="<?php echo $child4;?>" id="child4_price"
                                        placeholder="Enter Price" name="child4_price" required>
            ...
            <a href="meal.php" name="cancel" class="btn btn-danger">Cancel</a>
        </div>
