...
include('config.php');
include('header.php');
include('module/online_payment.php');
?>
...
<div class="breadcrumb">
    ...
    <a class="copad" href="dashboard.php">Home</a> <span class="pl-2 pr-2">/</span> <a>Online Payment</a>
               ...
               <div class="card-header">
                ...
                <div class="card-body">
                   <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12 mb-4  forminput" style="display:none">
                           ...
                           <div class="col-12 mb-4  forminput">
                                <label for="desc">Bank Details <span class="text-danger">*</span></label> <br>
                            ...
                            <div class="col-12 mb-4  forminput">
                                <label>Upload QR Image <span class="text-danger">*</span></label>
                                <input type="file" name="uploadpayment" id="uploadpayment" class="form-control">
                                <?php 
                                if($image != '') {
