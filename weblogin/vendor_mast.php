                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-4 mb-4 forminput">
                                ...
                                <div id="username_err" class="errordiv text-danger"></div>
                            </div>

                            <div class="col-4 mb-4 forminput">
                                <label for="contact"> Contact No.</label>
                                <input type="text" class="form-control" value="<?php echo $contact ?>" id="contact"
                                    placeholder="Enter contact" name="contact"  pattern="[0-9]{10}">
                            ...
                            <?php if($eid == ''){
                                echo '<label> Password <span class="red text-danger">*</span></label>
                                <input type="text" required placeholder="Enter Password"
                                class="form-control form-control-user" name="npass" value=""
                                id="npass">';
                                }
                            else {
                            echo '<label> Password <span class=""></label>
                            <input type="text" placeholder="Enter New Password"
                                    class="form-control form-control-user" name="npass" value="'.$npass.'"
                                    id="npass">';
                           }?>    
                                <div id="npass_err" class="errordiv text-danger"></div>
                            </div>
                            ...
                            <div class="col-4 mb-4 forminput">
                                ...
                                <input type="text" class="form-control" value="<?php echo $pin ?>" id="pin"
                            ...
                            <div class="col-12 text-right">
                                ...
                                <a href="vendor_mast.php" name="cancel" class="btn btn-danger">Cancel</a>
                            </div>
