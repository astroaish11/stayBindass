...
if(isset($_POST['submit'])) 
{
	...
	$desc = mysqli_real_escape_string($sql,$_POST['desc']);
     ...
     if($pid == ''){
        ...
        echo '<script type="text/javascript">window.location.href="seo_page.php?s=1"</script>';
    }
    else{
    ...
    echo '<script type="text/javascript">window.location.href="seo_page.php?u=1"</script>';
        }
	...
	echo '<script type="text/javascript">window.location.href="seo_page.php?pid='.$pid.'&u=1";</script>';
}	
...
if(isset($_GET['pid'])) 
{
   ...
   if(isset($_GET['did'])) {
    ...
    $cdate = date('Y-m-d H:i:s');
        ...
        mysqli_query($sql, "UPDATE `seo_pages` SET `deleted` = 1, `updated_date` = '$cdate', `updated_by` = '1' where `id` = '$did'");

        echo '<script type="text/javascript">window.location.href="seo_page.php?d=1"</script>';
        }
