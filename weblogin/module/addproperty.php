...
if (isset($_POST['submit'])) {
    ...
    if ($eid == '') {
       ...
       echo '<script type="text/javascript">window.location.href="vendorvillalist.php?u=1"</script>';
        }
    }
...
function vendor($sql, $vendors)
{
    ...
    $query6 = mysqli_query($sql, "SELECT * FROM `vendor_master` WHERE `deleted` != 1 and `vendor_status` != 1");
...
function room($sql, $room)
{
    ...
    $query5 = mysqli_query($sql, "SELECT * FROM `room_master` WHERE `deleted` != 1 and `room_status` != 1");
...
function home($sql, $home)
{
    ...
    $query4 = mysqli_query($sql, "SELECT * FROM `home_master` WHERE `deleted` != 1 and `bathroom_status` != 1");
...
function night($sql, $nightname)
{
    ...
    $query2 = mysqli_query($sql, "SELECT * FROM `night_master`  where `deleted` != 1 and `night_status` != 1");
...
function pool($sql, $poolname)
{
    ...
    $query2 = mysqli_query($sql, "SELECT * FROM `pool_master` where `deleted` != 1 and `pool_status` != 1");
...
function destination($sql, $destinationname)
{
    ...
    $query2 = mysqli_query($sql, "SELECT * FROM `destination_master` where `deleted` != 1 and `destination_status` != 1");
...
function property_category($sql, $prop_cat)
{
    ...
    //for all categories
    $query2 = "SELECT * FROM `awt_filters` WHERE `deleted` != 1 and `propcat_status` != 1";
    
    //for enabled categories only
...
function amenitiesname($sql, $amenities_name)
{
   ...
   $query2 = "SELECT * FROM `awt_facilities` WHERE `deleted` != 1 and `facilities_status` != 1";
