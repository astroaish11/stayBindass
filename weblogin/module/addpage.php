...
if(isset($_GET['pid'])) 
{
   ...
   if(isset($_GET['did'])) {
    ...
    $cdate = date('Y-m-d H:i:s');
        ...
        mysqli_query($sql, "UPDATE `static_pages` SET `deleted` = 1, `updated_date` = '$cdate', `updated_by` = '1' where `id` = '$did'");

        echo '<script type="text/javascript">window.location.href="add_page.php?d=1"</script>';
        }
