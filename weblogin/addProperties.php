...
<h1 class="h3 topTitle">
    ...
    <?php 
    if($_GET['vid']){
        echo'<a class="btn btn-primary btn-sm float-right" href="vendorvillalist.php?eid='.$_GET['vid'].'" role="button">
        List Property
    </a>';
    }else{
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <?php if ($eid != '') {
                        ...
                        <a  href="property_price.php?pid=' . $getdata->id . '" role="button">
                            Add Price
                        </a> </button>
                        <button class="tablink float-right"  >
                        <a  href="blockDates.php?pid=' . $getdata->id . '" role="button">
                            Block Dates
                        </a> </button>
                        <button class="tablink float-right"  >
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-4 mb-4  forminput">
                                ...
                                <?php if ($eid != '') {
                                    $vendorname = mysqli_query($sql,"SELECT v.*,a.property_by FROM `addproperty` as a
                                    left Join `vendor_master` as v on v.id = a.property_by 
                                    WHERE a.id='$eid' and a.deleted!= 1 and v.deleted!= 1");
                         
                                    $getvendorname = mysqli_fetch_object($vendorname);

                                    echo'<input type="hidden" id="vendor" class="form-control" name="vendor"
                                    value="'.$getvendorname->id.'" />
                                    <input type="text" id="display_vendor" class="form-control" name="display_vendor"
                                    value="'.$getvendorname->name.'" placeholder="" readonly />';
                                }else if($oid != ''){
                                    
                                    $vendorname = mysqli_query($sql,"SELECT v.*,a.property_by FROM `addproperty` as a
                                    left Join `vendor_master` as v on v.id = a.property_by 
                                    WHERE v.id='$oid' and a.deleted!= 1 and v.deleted!= 1");
                                    ...
                                    echo '<select name="vendor" id="vendor" class="form-control">
                                    <option value="">Select Vendor</option>';
                                     vendor($sql, $vendor); 
                                   echo '<div id="vendor_err" class="errordiv text-danger"></div>
                                    </select>';
                                } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 mb-4 forminput">
                                ...
                                <input type="text" id="maxguest" class="form-control" name="maxguest"
                                    value="<?php echo $maxguest; ?>" placeholder="Enter Maximum Guests" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-2 mb-4  forminput">
                                ...
                                <select name="propcat[]" id="propcat" class="form-control" multiple
                                    multiselect-search="true" multiselect-select-all="true" multiselect-max-items="30"
                                    required>
                        ...
                        <div class="row">
                            <div class="col-12 mb-4  forminput">
                                ...
                                <textarea name="overview" id="overview" class="form-control" required row="4"
                                    ><?php echo $overview; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-12 mb-4  forminput">
                                ...
                                <textarea name="rules" id="rules" class="form-control"
                                    row="4"><?php echo $rules; ?></textarea>
                                <div id="rules_err" class="errordiv text-danger"></div>
                            </div>
                            <div class="col-12 mb-4  forminput">
                                <label for="security">Security </label> <br>
                                <textarea name="security" id="security" class="form-control"
                                    row="4"><?php echo $security; ?></textarea>
                                <div id="security_err" class="errordiv text-danger"></div>
                            </div>
                            <div class="col-12 mb-4  forminput">
                                <label for="policies">Policies </label> <br>
                                <textarea name="policies" id="policies" class="form-control"
                                    row="4"><?php echo $policies; ?></textarea>
...
<script type="text/javascript" src="<?php echo MAINLINK;?>js/distributer.js"></script>
...
<script>
    $(document).ready(function () {
        ...
        $('#city').change(function () {
            ...
            var dataString = 'generatelatlong=' + cityid;
            $.ajax({
                type: "POST",
                url: "ajax_function.php",
                data: dataString,
                ...
                success: function (data) {
                    ...
                    $("#latitude").val(myObj.latitude);
                    $("#longitude").val(myObj.longitude);
