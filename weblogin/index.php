...
<head>
    ...
    <link href="<?php echo MAINLINK;?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet"> 

    <!-- Custom styles for this template-->
    <link href="<?php echo MAINLINK;?>css/sb-admin-2.min.css" rel="stylesheet">
...
<body style="background-color:aliceblue" class=" bg-gradient-primary  ">
                            ...
                            <div class="col-md-12">
                                <div class="p-4">
                                    ...
                                    <form action="" method="post"> 
                                       ...
                                       <div style="text-align: center; margin: -10px 0 0px; color: red;" id="errorMsg"><?php echo $errorMsg; ?></div>
    ...
    <script src="<?php echo MAINLINK;?>vendor/jquery/jquery.min.js"></script>
    <script src="<?php echo MAINLINK;?>vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?php echo MAINLINK;?>vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="<?php echo MAINLINK;?>js/sb-admin-2.min.js"></script>

    <script type="text/javascript" src="<?php echo MAINLINK;?>js/validate/login.js">
