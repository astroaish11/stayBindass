...
<script src="https://code.jquery.com/jquery-3.3.1.min.js?v=<?php echo time(); ?>" integrity="sha384-tsQFqpEReu7ZLhBV2VZlAu7zcOV+rXbYlF2cqB8txI/8aZajjp4Bqd+V6D5IgvKT" crossorigin="anonymous"></script>

  <script src="https://code.jquery.com/jquery-1.12.4.min.js?v=<?php echo time(); ?>"></script>
  <script src="<?php echo WEBLINK; ?>js/vendors.js?v=<?php echo time(); ?>"></script>
  <script src="<?php echo WEBLINK; ?>js/main.js?v=<?php echo time(); ?>"></script>
<script src="<?php echo WEBLINK; ?>js/jquery.sidebarFix.js?v=<?php echo time(); ?>" type="text/javascript"></script>
...
! function() {
  ...
  autoplaySpeed:2000,
        ...
        function() {
          const e = document.querySelectorAll(".js-liveSearch");
          if (!e) return;
          const t = [<?php echo citySearchAutocompleteListing($sql); ?>];
          e.forEach(e => {
          ...
          const n = (e, n) => {
            n.innerHTML = "", t.filter(t => t.city.toLowerCase().includes(e)).forEach(e => {
              ...
              //t.innerHTML = `\n          <button class="">\n            <div class="d-flex">\n              <div class="icon-location-2 text-light-1 text-20 pt-4"></div>\n              <div class="ml-10">\n                <div class="text-15 lh-12 fw-500">${e.city}</div>\n                <div class="text-14 lh-12 text-light-1 mt-5">${e.country}</div>\n              </div>\n            </div>\n          </button>\n        `, n.appendChild(t)
              t.innerHTML = `\n          <div class="clickcity" data-cityid="${e.cityid}" data-cityname="${e.city}">\n            <a class="-link d-block col-12 text-left rounded-4 px-20 py-15 js-search-option">\n            <div class="d-flex">\n            <div class="icon-location-2 text-light-1 text-20 pt-4"></div>\n            <div class="ml-10">\n            <div class="text-15 lh-12 fw-500 js-search-option-target searchcity">${e.city}</div>\n            <!--<div class="text-14 lh-12 text-light-1 mt-5 searchstate">${e.state}</div>-->\n            </div>\n            </div>\n            </a>\n            </div>`, n.appendChild(t)
            })
          }
        }(),
        function() {
...
<script type="text/javascript" src="<?php echo WEBLINK; ?>js/good-share.min.js?v=<?php echo time(); ?>"></script>
<script src="<?php echo WEBLINK; ?>js/price_range_script.js?v=<?php echo time(); ?>" type="text/javascript"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js?v=<?php echo time(); ?>" type="text/javascript"></script>


    <script src="<?php echo WEBLINK; ?>js/calendar.js?v=<?php echo time(); ?>"></script>
    <!-- <script type="text/javascript" src="js/events.js?v=<?php //echo time(); ?>"></script> -->

    <!-- ENQUIRY FORM -->


 <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js?v=<?php echo time(); ?>" integrity="sha384-fQybjgWLrvvRgtW6bFlB7jaZrFsaBXjsOMm/tB9LTS58ONXgqbR9W8oWht/amnpF" crossorigin="anonymous"></script>
...
<script src="<?php echo WEBLINK; ?>js/tab.js?v=<?php echo time(); ?>"></script>
    <script type="text/javascript">
  ...
  <script src="<?php echo WEBLINK; ?>js/t-datepicker.min.js?v=<?php echo time(); ?>"></script>
...
<script>
 ...
 $(window).scroll(function() {
    $.each($('img'), function() {
        if ( $(this).attr('data-src') && $(this).offset().top < ($(window).scrollTop() + $(window).height() + 2) ) {
...
<!-- <script type="text/javascript">
    (function () {
        var options = {
            call: "8657011171", // Call phone number
            whatsapp: "+918657011172", // WhatsApp number
            call_to_action: "Message us", // Call to action
            button_color: "#ab2440", // Color of button
...
<!-- share -->
<!--   <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=63543026cf64e00013d81eba&product=inline-share-buttons&source=platform" async="async"></script> -->
...
<script type="text/javascript" src="https://pdfanticopy.com/noprint.js?v=<?php //echo time(); ?>"></script>
 -->

<!-- Right click and copy pest disable -->
<script>
    $(document).ready(function() {
 ...
 <script src="https://unpkg.com/ityped@0.0.10"></script>
      <script>
            window.ityped.init(document.querySelector('.ityped'),{
                strings: ['Explore Your Next Luxurious Staycation','Explore Your Next Luxurious Staycation','Explore Your Next Luxurious Staycation'],
                loop: true
            })
        </script>
...
<script>
    ...
    function fncShow(ctrl){ // ฟังก์ชั่นสำหรับ แสดง (Show) ส่งค่า id ของ DIV หรือ Table TD TR
        ...
        document.getElementById('embed_button').innerHTML ='<button type="submit" name="Submit" class="btn-search" onClick="JavaScript:fncHide(\'embed_div\');"><i class="fa fa-search"></i> Search for a destination or a home</button>'; // หลังจากสั่งให้แสดงเสร็จ ก็ทำการเปลี่ยนสถานะของปุ่มเป็น "ซ่อน"
    }
    ...
    function fncHide(ctrl){ // ฟังก์ชั่นสำหรับ ซ่อน ส่งค่า id ของ DIV หรือ Table TD TR
        ...
        document.getElementById('embed_button').innerHTML ='<button type="submit" name="Submit" class="btn-search" onClick="JavaScript:fncShow(\'embed_div\');"><i class="fa fa-search"></i> Search for a destination or a home</button>';  // หลังจากสั่งให้ซ่อนแล้ว ก็ทำการเปลี่ยนสถานะของปุ่มเป็น "แสดง"
    }
</script>

<script src="<?php echo WEBLINK; ?>js/jquery.lightbox.js?v=<?php echo time(); ?>"></script>
<script>
  // Initiate Lightbox
  $(function() {
    $('.gallery a').lightbox(); 
...
var appendthis =  ("<div class='modal-overlay1 js-modal-close'></div>");

    $('a[data-modal-id]').click(function(e) {
        e.preventDefault();
    $("body").append(appendthis);
    $(".modal-overlay1").fadeTo(500, 0.7);
...
$(".js-modal-close, .modal-overlay1").click(function() {
    $(".modal-box, .modal-overlay1").fadeOut(500, function() {
